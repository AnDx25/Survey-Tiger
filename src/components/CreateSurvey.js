...
import '../components_css/TakeSurvey.css'
const options = [
  ...
  class CreateSurvey extends React.Component {
    ...
    render() {
      ...
      return (
        ...
        <div class="content">
        <div class="header">
        <h1 > <PetsSharpIcon /> Survey Tiger</h1>
        </div>
        <div class="body">
        <Select 
      ...
      {this.state.callforsubmit===1 ? <ShowAllQuestion data={this.state.questions}/> :  <div>     
        ...
        {this.state.multi1.submit!==undefined  && <Button className="button" onClick={()=> this.update()}> Add Question</Button>}
        {this.state.multi1.submit!==undefined && <Button  className="button" onClick={ ()=> this.callforsubmit() } > Publish</Button>}</div>}
